const styles = {
  ...
  heading:
    "text-[27px] text-center md:text-start font-[600] roboto-thin pb-[20px]",
  ...
  shop_name: "font-NeueHaasUnica text-[15px] text-blue-400 pb-3",
  active_indicator: "absolute bottom-[-27%] left-0 h-[3px] w-full bg-[crimson]",
  button:
    "w-[150px] bg-black h-[50px] my-3 flex items-center justify-center cursor-pointer",
  cart_button:
